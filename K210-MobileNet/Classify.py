...
if __name__ == "__main__":
    try:
        labels = ["Battery", "Brokenceramics", "Cans", "Cigarettebutts", "Fruit", "Paper", "Tile", "Vegetables", "Walterbottles"]
        # main(labels=labels, model_addr=0x300000)
        main(labels=labels, model_addr=0x500000, sensor_hmirror=True, sensor_vflip=True)
    except Exception as e:
